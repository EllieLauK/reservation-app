    ...
    <main className="flex-1">
      ...
      <section className="relative bg-gradient-to-br from-purple-50 to-fuchsia-50 py-24 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <Link
            href={`/${locale}/book`}
            className="inline-block bg-purple-700 text-white px-8 py-3.5 rounded-full text-base font-semibold hover:bg-purple-800 transition-colors shadow-lg shadow-purple-200"
          >
            {h.heroCTA}
          </Link>
        </div>
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-fuchsia-100 rounded-full opacity-50 blur-3xl" />
        </div>
      </section>
      ...
      {/* Services */}
      <section id="services" className="py-20 px-6 bg-purple-50">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {services.map(service => (
              <div key={service.id} className="bg-white rounded-2xl p-5 shadow-sm border border-purple-50 hover:shadow-md transition-shadow">
                <span className="inline-block text-xs font-medium text-purple-700 bg-purple-50 px-2 py-0.5 rounded-full mb-3">
          ...
          <div className="text-center mt-10">
            <Link href={`/${locale}/book`} className="inline-block bg-purple-700 text-white px-7 py-3 rounded-full font-medium hover:bg-purple-800 transition-colors">
              {h.bookService}
            </Link>
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-purple-700 text-white text-center">
        ...
        <p className="text-purple-100 mb-8 max-w-md mx-auto">{h.ctaDesc}</p>
        <Link href={`/${locale}/book`} className="inline-block bg-white text-purple-700 px-8 py-3.5 rounded-full font-semibold hover:bg-purple-50 transition-colors shadow-lg">
          {h.ctaButton}
        </Link>
      </section>
